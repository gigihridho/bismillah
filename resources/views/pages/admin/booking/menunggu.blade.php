                            ...
                            <tr style="text-align: center">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('batal',$tf->id) }}" method="POST" enctype="multipart/form-data" style="display:inline-block">
                                        @csrf
                                        @method('PUT')
                                        <button value="CANCELLED" type="submit" title="Hapus" data-toggle="tooltip" data-placement="top" class="btn btn-danger btn-sm" onclick="return confirm('Anda ingin membatalkan pemesanan kamar ini ?')">
